...
class DetailViewModel: ObservableObject {
    ...
    private func createOverviewArray(coinModel: CoinModel) -> [StatisticModel] {
        ...
        let priceStat = StatisticModel(title: "Curent Price", value: price, percentageChange: pricePercentChange)
    ...
    func createAdditionArray(coinDetailModel: CoinDetailModel?, coinModel: CoinModel) -> [StatisticModel] {
